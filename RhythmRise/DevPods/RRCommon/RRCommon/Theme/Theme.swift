...
struct AppDarkTheme: IRRTheme {
    ...
    var textWhiteColor: Color { return Color(hexString: "#FFFFFF", opacity: 1)! }
    var textNoteColor: Color { return Color(hexString: "#8CAAB9", opacity: 0.6)! } // "#262626")! }
