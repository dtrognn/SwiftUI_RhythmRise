...
public class BannerAlertMessageConfiguration: IAlertMessage {
    ...
    public func showMessage(_ message: String, style: AlertMessageStyle) {
...
public class DefaultAlertMessageConfiguration: BannerAlertMessageConfiguration {}
